...
///
/// ikfast version 0x10000049 generated on 2019-12-02 14:07:50.353574
/// To compile with gcc:
///     gcc -lstdc++ ik.cpp
...
IkReal x53=((1.0)*x25);
eetrans[0]=(((x19*x30))+(((-1.0)*x16*x53))+((x0*x18))+((x14*x27))+((x16*x28))+((x9*(((((-1.0)*x24*x53))+((x24*x28))))))+x19+((x10*((((x22*x44))+(((-1.0)*x13*x5)))))));
eerot[3]=(((x51*x8))+((x11*((((x10*x42))+((x52*x9)))))));
eerot[4]=(((x11*x51))+((x8*(((((-1.0)*x12*x52))+(((-1.0)*x23*x42)))))));
eerot[5]=(((x10*x52))+((x9*(((((-1.0)*x34))+((x28*x7)))))));
IkReal x54=((1.0)*x25);
eetrans[1]=(((x18*x7))+((x21*x28))+((x9*(((((-1.0)*x13*x54))+((x13*x28))))))+((x15*x30))+x15+(((-1.0)*x21*x54))+((x14*x2*x7))+((x10*((((x22*x46))+((x24*x5)))))));
eerot[6]=(((x39*x8))+((x11*((x40+((x38*x9)))))));
eerot[7]=(((x8*(((((-1.0)*x12*x38))+(((-1.0)*x23*x37))))))+((x11*x39)));
eerot[8]=(((x26*x35))+(((-1.0)*x37*x9)));
eetrans[2]=((0.495)+((x26*(((((-0.135)*x28))+(((0.135)*x25))))))+((x14*x4))+(((1.095)*x3))+(((-1.27)*x30))+(((-1.27)*x29))+(((-0.175)*x25))+((x9*(((((-0.135)*x29))+(((-0.135)*x30)))))));
}
...
if( (((1.00154729145541)+(((0.12466248282205)*py*sj0))+(((-0.356178522348714)*pp))+(((0.12466248282205)*cj0*px)))) < -1-IKFAST_SINCOS_THRESH || (((1.00154729145541)+(((0.12466248282205)*py*sj0))+(((-0.356178522348714)*pp))+(((0.12466248282205)*cj0*px)))) > 1+IKFAST_SINCOS_THRESH )
    continue;
IkReal x60=IKasin(((1.00154729145541)+(((0.12466248282205)*py*sj0))+(((-0.356178522348714)*pp))+(((0.12466248282205)*cj0*px))));
j2array[0]=((-3.00465970603075)+(((-1.0)*x60)));
sj2array[0]=IKsin(j2array[0]);
cj2array[0]=IKcos(j2array[0]);
j2array[1]=((0.136932947559044)+x60);
...
IkReal x66=(py*sj0);
IkReal x67=((0.175)*pz);
IkReal x68=((41.469387755102)*cj2);
IkReal x69=(sj2*x66);
j1eval[0]=((((-5.71428571428571)*sj2*x63))+(((-1.0)*x66*x68))+sj2+(((7.25714285714286)*cj2))+(((-41.469387755102)*x64))+(((-5.71428571428571)*x69))+(((35.7551020408163)*pz))+(((-1.0)*x63*x68))+(((5.71428571428571)*cj2*pz)));
j1eval[1]=((IKabs(((0.22225)+(((-0.191625)*sj2))+(((-0.4445)*x61))+(((1.582275)*x62))+(((-1.39065)*cj2))+(((-1.0)*x67))+((pz*x66))+((pz*x63)))))+(IKabs(((-0.030625)+(((-0.4445)*x62))+(((-1.582275)*x61))+(pz*pz)))));
j1eval[2]=IKsign(((((0.22225)*cj2))+(((1.095)*pz))+(((-0.175)*sj2*x63))+(((-1.0)*x65*x66))+(((-1.0)*x63*x65))+((cj2*x67))+(((-1.27)*x64))+(((-0.175)*x69))+(((0.030625)*sj2))));
if( IKabs(j1eval[0]) < 0.0000010000000000  || IKabs(j1eval[1]) < 0.0000010000000000  || IKabs(j1eval[2]) < 0.0000010000000000  )
{
{
IkReal j1eval[2];
IkReal x70=(py*sj0);
IkReal x71=((0.175)*cj2);
IkReal x72=((41.469387755102)*sj2);
IkReal x73=((5.71428571428571)*cj2);
IkReal x74=(cj0*px);
IkReal x75=(pz*sj2);
IkReal x76=((1.27)*sj2);
IkReal x77=(cj2*pz);
j1eval[0]=((6.25714285714286)+cj2+(((-1.0)*x70*x73))+(((-41.469387755102)*x77))+(((-35.7551020408163)*x70))+(((-35.7551020408163)*x74))+(((-5.71428571428571)*x75))+(((-1.0)*x73*x74))+((x70*x72))+((x72*x74))+(((-7.25714285714286)*sj2)));
j1eval[1]=IKsign(((0.191625)+(((0.030625)*cj2))+(((-0.175)*x75))+(((-0.22225)*sj2))+(((-1.0)*x70*x71))+(((-1.095)*x70))+(((-1.095)*x74))+(((-1.0)*x71*x74))+((x70*x76))+((x74*x76))+(((-1.27)*x77))));
...
CheckValue<IkReal> x94 = IKatan2WithCheck(IkReal(((0.191625)+((x89*x90))+(((0.030625)*cj2))+(((-0.22225)*sj2))+(((-1.095)*x89))+(((-1.095)*x91))+((pz*x92))+((pz*x93))+((x90*x91))+(((-1.0)*x88*x89))+(((-1.0)*x88*x91)))),IkReal(((((-1.095)*pz))+(((0.22225)*cj2))+(((-1.0)*x91*x93))+(((-1.0)*x91*x92))+((pz*x90))+(((-1.0)*pz*x88))+(((-1.0)*x89*x92))+(((-1.0)*x89*x93))+(((0.030625)*sj2)))),IKFAST_ATAN2_MAGTHRESH);
if(!x94.valid){
continue;
}
CheckValue<IkReal> x95=IKPowWithIntegerCheck(IKsign(((-0.030625)+(((0.35)*x91))+((x86*x87))+(((0.35)*x89))+(((-2.0)*x89*x91))+(((-1.0)*x86))+(((-1.0)*(pz*pz)))+(((-1.0)*x87*(px*px))))),-1);
if(!x95.valid){
continue;
}
...
IkReal x99=((1.27)*cj2);
IkReal x100=(py*sj0);
IkReal x101=((1.27)*sj2);
IkReal x102=((0.175)*cj2);
IkReal x103=((1.0)*x97);
IkReal x104=((0.175)*x97);
IkReal x105=(pz*x97);
IkReal x106=((0.175)*x96);
IkReal x107=((2.19)*x96);
evalcond[0]=((-1.095)+((x96*x98))+((x100*x96))+(((-1.0)*x106))+(((-1.0)*x102))+x105+x101);
evalcond[1]=((((0.175)*sj2))+(((-1.0)*x103*x98))+(((-1.0)*x100*x103))+x104+((pz*x96))+x99);
evalcond[2]=(((x96*x99))+(((-1.0)*x102*x97))+((sj2*x106))+((x101*x97))+(((-1.095)*x97))+pz);
evalcond[3]=((0.413875)+(((2.19)*x105))+(((0.35)*x100))+(((-0.38325)*x96))+((x107*x98))+(((0.35)*x98))+(((-1.0)*pp))+((x100*x107)));
evalcond[4]=((0.175)+((sj2*x104))+((x102*x96))+((x97*x99))+(((1.095)*x96))+(((-1.0)*x101*x96))+(((-1.0)*x98))+(((-1.0)*x100)));
...
IkReal x645=(cj0*px);
IkReal x646=(py*sj0);
IkReal x647=((0.175)*pz);
IkReal x648=((1.0)*pz);
IkReal x649=((1.27)*sj2);
CheckValue<IkReal> x650 = IKatan2WithCheck(IkReal(((-2.811925)+(((-0.38325)*cj2))+(((0.4445)*x643))+(pz*pz)+(((2.7813)*sj2))+(((1.582275)*x642)))),IkReal(((0.22225)+(((-0.191625)*sj2))+(((-1.0)*x646*x648))+x647+(((-1.39065)*cj2))+(((-1.0)*x645*x648))+(((-0.4445)*x642))+(((1.582275)*x643)))),IKFAST_ATAN2_MAGTHRESH);
if(!x650.valid){
continue;
}
CheckValue<IkReal> x651=IKPowWithIntegerCheck(IKsign(((0.191625)+(((-1.27)*cj2*pz))+(((-1.095)*x645))+(((-1.095)*x646))+(((0.030625)*cj2))+(((-0.22225)*sj2))+(((-1.0)*sj2*x647))+((x645*x649))+(((-1.0)*x644*x645))+(((-1.0)*x644*x646))+((x646*x649)))),-1);
if(!x651.valid){
continue;
}
...
IkReal x654=(cj0*px);
IkReal x655=((1.27)*cj2);
IkReal x656=(py*sj0);
IkReal x657=((1.27)*sj2);
IkReal x658=((0.175)*cj2);
IkReal x659=((1.0)*x653);
IkReal x660=((0.175)*x653);
IkReal x661=(pz*x653);
IkReal x662=((0.175)*x652);
IkReal x663=((2.19)*x652);
evalcond[0]=((-1.095)+((x652*x654))+((x652*x656))+(((-1.0)*x658))+(((-1.0)*x662))+x657+x661);
evalcond[1]=((((0.175)*sj2))+((pz*x652))+(((-1.0)*x656*x659))+x655+x660+(((-1.0)*x654*x659)));
evalcond[2]=((((-1.095)*x653))+((x652*x655))+((x653*x657))+pz+((sj2*x662))+(((-1.0)*x653*x658)));
evalcond[3]=((0.413875)+(((2.19)*x661))+((x656*x663))+(((-1.0)*pp))+(((0.35)*x656))+(((0.35)*x654))+((x654*x663))+(((-0.38325)*x652)));
evalcond[4]=((0.175)+(((-1.0)*x656))+(((-1.0)*x654))+((x652*x658))+((x653*x655))+(((1.095)*x652))+((sj2*x660))+(((-1.0)*x652*x657)));
if( IKabs(evalcond[0]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[1]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[2]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[3]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[4]) > IKFAST_EVALCOND_THRESH  )
{
continue;
}
...
IkReal x665=(cj2*sj2);
IkReal x666=(py*sj0);
IkReal x667=((0.175)*pz);
IkReal x668=(cj0*px);
IkReal x669=((0.175)*sj2);
IkReal x670=((1.27)*cj2);
CheckValue<IkReal> x671 = IKatan2WithCheck(IkReal(((0.22225)+(((-0.191625)*sj2))+(((-1.0)*x667))+(((1.582275)*x665))+((pz*x666))+((pz*x668))+(((-1.39065)*cj2))+(((-0.4445)*x664)))),IkReal(((-0.030625)+(pz*pz)+(((-1.582275)*x664))+(((-0.4445)*x665)))),IKFAST_ATAN2_MAGTHRESH);
if(!x671.valid){
continue;
}
CheckValue<IkReal> x672=IKPowWithIntegerCheck(IKsign((((cj2*x667))+(((0.22225)*cj2))+(((1.095)*pz))+(((-1.0)*x668*x670))+(((-1.0)*x666*x670))+(((-1.0)*x668*x669))+(((-1.0)*x666*x669))+(((-1.27)*pz*sj2))+(((0.030625)*sj2)))),-1);
if(!x672.valid){
continue;
}
...
IkReal x675=(cj0*px);
IkReal x676=((1.27)*cj2);
IkReal x677=(py*sj0);
IkReal x678=((1.27)*sj2);
IkReal x679=((0.175)*cj2);
IkReal x680=((1.0)*x674);
IkReal x681=((0.175)*x674);
IkReal x682=(pz*x674);
IkReal x683=((0.175)*x673);
IkReal x684=((2.19)*x673);
evalcond[0]=((-1.095)+((x673*x677))+((x673*x675))+(((-1.0)*x683))+x678+x682+(((-1.0)*x679)));
evalcond[1]=((((0.175)*sj2))+((pz*x673))+(((-1.0)*x675*x680))+x676+x681+(((-1.0)*x677*x680)));
evalcond[2]=(((x673*x676))+((sj2*x683))+((x674*x678))+(((-1.095)*x674))+pz+(((-1.0)*x674*x679)));
evalcond[3]=((0.413875)+(((0.35)*x677))+(((0.35)*x675))+((x677*x684))+(((-0.38325)*x673))+(((2.19)*x682))+(((-1.0)*pp))+((x675*x684)));
evalcond[4]=((0.175)+((x673*x679))+((sj2*x681))+((x674*x676))+(((-1.0)*x677))+(((-1.0)*x675))+(((1.095)*x673))+(((-1.0)*x673*x678)));
if( IKabs(evalcond[0]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[1]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[2]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[3]) > IKFAST_EVALCOND_THRESH  || IKabs(evalcond[4]) > IKFAST_EVALCOND_THRESH  )
{
continue;
}
...
IKFAST_API const char* GetKinematicsHash() { return "63cc0e65ce0fb2cde4e60a0b4f60f1a3"; }
